		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ route('admin.brand.postAdd') }}"  enctype = "multipart/form-data">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">

						<div class="form-group">
							<label class="col-md-4 control-label">Tên Hãng</label>
							<div class="col-md-6">
								<input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nhập Tên Hãng">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select name="country" id="cmbCountry" style = "padding: 5px 0px 5px 5px; width:150px">
									...
									<option value="United Kingdom (Great Britain)">United Kingdom (Great Britain)</option><option value="United States" selected>United States</option>
									...
									<option value="Yemen">Yemen</option><option value="Zaire">Zaire</option><option value="Zambia">Zambia</option></select>
							</div>
