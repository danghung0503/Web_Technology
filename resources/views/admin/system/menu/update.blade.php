				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action=""  enctype = "multipart/form-data" id = "updateForm">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<select name="item_parent" id="" class = "form-control">
									...
									<?php showItemMenu($data,0,'--',$imenu->parent_id)?>
								</select> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" name="name" value="{!!old('name',isset($imenu->name)?$imenu->name:null)!!}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" name="ordinal" value="{!!old('ordinal',isset($imenu->ordinal)?$imenu->ordinal:null)!!}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea class = "form-control" name="description" value="">{!!old('description',isset($imenu->description)?$imenu->description:null)!!}</textarea>
								<script type = "text/javascript">
