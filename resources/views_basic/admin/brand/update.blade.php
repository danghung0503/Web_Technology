		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ route('admin.company.postUpdate') }}"  enctype = "multipart/form-data" id = "updateForm">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="file" name="logo"  style="margin-top: 5px; border: 1px solid #CCCCCC; width: 228px; border-radius: 5px;" value = "{{old('logo')}}"> 
							</div>
						</div>
